...
//       {/* Left: Form area */}
//       <div className="w-full md:w-[60vw] p-8 md:p-12 flex flex-col justify-between bg-violet-100">
//         <div>
...
export const AuthLayout = ({ children }) => {
  return (
    <div className="flex h-screen overflow-hidden items-center justify-center bg-gradient-to-br from-violet-200 via-fuchsia-100 to-violet-300 relative">
      {/* Soft Background Shapes */}
      <div className="absolute w-72 h-72 bg-fuchsia-400/25 rounded-full blur-3xl top-[-80px] left-[-100px]" />
      <div className="absolute w-64 h-64 bg-pink-300/20 rounded-full blur-2xl bottom-[-60px] right-[-80px]" />

      {/* Form card - now with tighter top/bottom spacing */}
      <div className="relative z-10 w-[90%] md:w-[35vw] max-w-sm mx-auto bg-white/80 backdrop-blur-md rounded-2xl shadow-xl p-5 md:p-6">
        ...
        <div className="mt-4 flex flex-col items-center space-y-1">
          <p className="text-xs text-gray-500 text-center">
            Secure & Simple Expense Management
          </p>
        </div>
      </div>
    </div>
